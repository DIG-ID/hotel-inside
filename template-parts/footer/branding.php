...
<div class="col">
	<div class="footer-branding">
		...
		<?php endif; ?>
		<p class="footer-title"><?php esc_html_e( 'Address', 'hotel-inside' ); ?></p>
		<?php if ( ! empty( $email ) ) : ?>
			<p class="contact-link"><span>E: </span><a href="mailto:<?php echo esc_attr( $email ); ?>"><?php echo esc_html( $email ); ?></a></p>
		<?php endif; ?>
		<?php if ( ! empty( $phone ) ) : ?>
			<p class="contact-link"><span>P: </span><a href="tel:<?php echo esc_attr( $phone ); ?>"><?php echo esc_html( $phone ); ?></a></p>
		<?php endif; ?>
	</div><!-- .site-name -->
</div>
