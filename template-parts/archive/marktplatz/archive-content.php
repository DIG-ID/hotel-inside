		...
		<div class="row">
			<div class="col-12">
				...
				<div class="navbar-form navbar-left markt-search-form">
					<div class="form-group form-cats">
						<?php
						...
						if ( ! empty( $makrt_terms ) ) :
							echo '<select id="markt_cat_filter" name="categoryfilter"><option value="">Alle</option>';
				...
				<script type="text/javascript">
					jQuery(document).ready(function($) {
						...
						$('#markt_cat_filter option').each(function() {
							if($(this).is(':selected')) {
								var markt_cat = $(this).val();
