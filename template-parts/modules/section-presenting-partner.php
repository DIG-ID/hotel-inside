...
if ( have_rows( 'partners', 'presenting_partner' ) ) :
	...
	<section id="presenting-partner" class="section section-presenting-partner">
		<div class="custom-container">
			...
			<div class="row justify-content-center align-items-center">
				<div class="col-12 swiper swiper-presenting-partner">
					...
					while ( have_rows( 'partners', 'presenting_partner' ) ) :
						...
						echo '<div class="swiper-slide col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 text-center presenting-partner-card">';
