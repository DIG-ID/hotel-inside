	...
	<div class="custom-container">
		...
		if ( have_rows( 'partners', 'presenting_partner' ) ) :
			...
			while ( have_rows( 'partners', 'presenting_partner' ) ) :
				...
				echo '<div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-6 text-center presenting-partner-card">';
			...
			echo '<p class="text-center">' . esc_html__( 'No preseting partner has been added so far', 'hotel-inside' ) . '</p>';
		endif;
		?>
	</div>
</section>
